...
.PHONY: help config config-upgrade check install setup doctor detect-thread-boundaries detect-blocking-io dev desktop-dev dev-daemon start start-daemon stop up down clean docker-init docker-start docker-stop docker-logs docker-logs-frontend docker-logs-gateway
...
help:
	...
	@echo "  make desktop-dev     - Start the Electron desktop development shell"
